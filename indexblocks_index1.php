...
<? if ($arMainPageOrder && is_array($arMainPageOrder)): ?>
    <? foreach ($arMainPageOrder as $key => $optionCode): ?>
        ...
        <? if ($optionCode == "BIG_BANNER_INDEX"): ?>
            ...
            <? if ($bBigBannersIndex): ?>
                <div class="drag-block container <?= $optionCode ?> <?= $bBigBannersIndexClass; ?>"
                     data-class="<?= $optionCode ?>_drag" data-order="<?= ++$key; ?>">
                    <div class="row margin0">
                        <? $APPLICATION->IncludeComponent(
                            ...
                            array(
                                ...
                                "COMPONENT_TEMPLATE" => "front-banners-big-long",
        ...
        <? if ($optionCode == "TEASERS_INDEX"): ?>
            ...
            <? if ($bTeasersIndex): ?>
                <div class="drag-block container <?= $optionCode ?> <?= $bTeasersIndexClass; ?>"
                     data-class="<?= $optionCode ?>_drag" data-order="<?= ++$key; ?>">
                    <div class="row margin0">
                        <? $APPLICATION->IncludeComponent(
                            "bitrix:news.list",
        ...
        <? if ($optionCode == "FLOAT_BANNERS_INDEX"): ?>
            <? //LEBERGRAM?>
            <? if ($USER->IsAdmin()): ?>
                <?= CAllcorp2::ShowPageType('mainpage', 'lebergram'); ?>
            <? endif; ?>
            ...
            <? if ($bFloatBannersIndex): ?>
                <div class="drag-block container <?= $optionCode ?> <?= $bFloatBannersIndexClass; ?>"
                     data-class="<?= $optionCode ?>_drag" data-order="<?= ++$key; ?>" style="border: none;">
        ...
        <? if ($optionCode == "PORTFOLIO_INDEX"): ?>
            ...
            <? if ($bPortfolioIndex): ?>
                <div class="drag-block container <?= $optionCode ?> <?= $bPortfolioIndexClass; ?>"
                     data-class="<?= $optionCode ?>_drag" data-order="<?= ++$key; ?>">
        ...
        <? if ($optionCode == "CATALOG_SECTIONS_INDEX"): ?>
            ...
            <? if ($bCatalogSectionsIndex): ?>
                <div class="drag-block container <?= $optionCode ?> <?= $bCatalogSectionsIndexClass; ?>"
                     data-class="<?= $optionCode ?>_drag" data-order="<?= ++$key; ?>">
                    <? $APPLICATION->IncludeComponent(
        ...
        <? if ($optionCode == "CATALOG_INDEX"): ?>
            ...
            <div class="drag-block container <?= $optionCode ?> <?= $bCatalogIndexClass; ?>"
                 data-class="<?= $optionCode ?>_drag" data-order="<?= ++$key; ?>">
                <? $APPLICATION->IncludeComponent(
                    "aspro:tabs.allcorp2",
                    ".default",
        ...
        <? if ($optionCode == "PARTNERS_INDEX"): ?>
            ...
            <? if ($bPartnersIndex): ?>
                <div class="drag-block container <?= $optionCode ?> <?= $bPartnersIndexClass; ?>"
                     data-class="<?= $optionCode ?>_drag" data-order="<?= ++$key; ?>">
                    <? $APPLICATION->IncludeComponent(
                        "bitrix:news.list",
                        "front-partners",
        ...
        <? if ($optionCode == "INSTAGRAMM_INDEX"): ?>
            ...
            <div class="drag-block container <?= $optionCode ?> <?= $bInstagrammIndexClass; ?>"
                 data-class="<?= $optionCode ?>_drag" data-order="<?= ++$key; ?>">
        ...
        <? if ($optionCode == "NEWS_INDEX"): ?>
            ...
            <? if ($bNewsIndex): ?>
                <div class="drag-block container <?= $optionCode ?> <?= $bNewsIndexClass; ?>"
                     data-class="<?= $optionCode ?>_drag" data-order="<?= ++$key; ?>">
                    <? $APPLICATION->IncludeComponent(
                        "bitrix:news.list",
                        "front-news",
        ...
        <? if ($optionCode == "MAP_INDEX"): ?>
            ...
            <? if ($bMapIndex): ?>
                <div class="drag-block container <?= $optionCode ?> <?= $bMapIndexClass ?>"
                     data-class="<?= $optionCode ?>_drag" data-order="<?= ++$key; ?>">
        ...
        <? if ($optionCode == "REVIEWS_INDEX"): ?>
            ...
            <? if ($bReviewsIndex): ?>
                <div class="drag-block container <?= $optionCode ?> <?= $bReviewsIndexClass; ?>"
                     data-class="<?= $optionCode ?>_drag" data-order="<?= ++$key; ?>">
                    <? $APPLICATION->IncludeComponent(
                        "bitrix:news.list",
                        "front-reviews",
        ...
        <? if ($optionCode == "COMPANY_INDEX"): ?>
            ...
            <? if ($bCompanyIndex): ?>
                <div class="drag-block container <?= $optionCode ?> <?= $bCompanyIndexClass; ?>"
                     data-class="<?= $optionCode ?>_drag" data-order="<?= ++$key; ?>">
                    <div class="row">
        ...
        <? if ($optionCode == "BLOG_INDEX"): ?>
            ...
            <? if ($bBlogIndex): ?>
                <div class="drag-block container <?= $optionCode ?> <?= $bBlogIndexClass; ?>"
                     data-class="<?= $optionCode ?>_drag" data-order="<?= ++$key; ?>">
                    <? $APPLICATION->IncludeComponent(
                        "bitrix:news.list",
                        "front-projects_1",
        ...
        <? endif; ?>
        <? //SLIDER_INDEX?>
        <? $inGroup = CSite::InGroup(array(1, 46)); ?>
        <? if ($inGroup == 1): ?>
            <? if ($optionCode == "SLIDER_INDEX"): ?>
                <? global $bSliderIndex, $bSliderIndexClass; ?>
                <? if ($bSliderIndex): ?>
                    <div class="drag-block container <?= $optionCode ?> <?= $bSliderIndexClass; ?>"
                         data-class="<?= $optionCode ?>_drag" data-order="<?= ++$key; ?>">
                        <? $APPLICATION->IncludeComponent(
                            "bitrix:news.list",
                            "slayder-partnerov",
                            array(
                                ...
                                "SET_META_DESCRIPTION" => "N",
                                "TITLE" => "Партнеры",
                                "RIGHT_TITLE" => "Наши партнеры",
                                "RIGHT_LINK" => "",
                                "COMPONENT_TEMPLATE" => "slayder-partnerov",
                                "SET_LAST_MODIFIED" => "N",
                                "STRICT_SECTION_CHECK" => "N",
                                "SHOW_DETAIL_LINK" => "Y",
                                "PAGER_BASE_LINK_ENABLE" => "N",
    ...
    <div class="maxwidth-theme flexbox">
       <div class="col-md-12 col-sm-12 col-xs-12">\
        ...
        $APPLICATION->IncludeComponent(
            ...
            "",
            [
                "IBLOCK_ID" => "aspro_allcorp2_projects",
                "REGION_PROP_CODE" => "REGIONS"
            ]
        );
